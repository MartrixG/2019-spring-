...
public interface CircularOrbit<L, E> {
     ...
     */
	static CircularOrbit newCircularOrbit(ApplicationType type, String fileName) throws InputException, DependencyException, GramarException {
		switch (type){
			case AtomStructure:
	 ...
	 * Else return false
	 */
	default boolean removeTrack(Track T) throws GramarException, DependencyException {
		return false;
	}
	 ...
	 */
	List<Pair<String, List<String>>> processParameter(String fileName);
